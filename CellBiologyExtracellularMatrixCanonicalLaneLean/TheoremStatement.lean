...
def sourceTheoremStatement : TheoremStatement := {
  sourceKey := "cell-biology-extracellular-matrix-canonical-lane",
  theoremName := "Extracellular Matrix Canonical Closure",
  theoremObject := "Cell biology extracellular matrix properties and dynamics",
...
def TheoremLayerInternalized : Prop :=
  sourceTheoremStatement.sourceKey = "cell-biology-extracellular-matrix-canonical-lane" ∧
  sourceTheoremStatement.certificateLane = "manifold_constrained" ∧
  ClassicalSourceBoundaryCarried ∧
  ManifoldConstrainedTheoremClosed

theorem theorem_statement_source_key_checked :
    sourceTheoremStatement.sourceKey = "cell-biology-extracellular-matrix-canonical-lane" := by
  rfl
